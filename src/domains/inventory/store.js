...
const inventory = ref([
  ...
  { id: 3, name: "Potloodstiften 2B 0.5", actualAmount: 8, minimumAmount: 10 },
  { id: 4, name: "Kneedgum", actualAmount: 14, minimumAmount: 10 },
  { id: 5, name: "Oostindische inkt 30ml", actualAmount: 4, minimumAmount: 5 },
...
export const getInventoryToOrder = computed(
  () => inventory.value.filter((data) => 
    data.actualAmount < data.minimumAmount)
);
